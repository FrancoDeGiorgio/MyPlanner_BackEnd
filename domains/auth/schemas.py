"""
Pydantic Schemas (DTO - Data Transfer Objects) per il dominio Auth.

Questi schemi definiscono la struttura dei dati in ingresso e uscita
dalle API REST, con validazione automatica tramite Pydantic.

IMPORTANTE: Separazione tra Models e Schemas
---------------------------------------------
- Models (models.py): Entità di dominio, logica di business
