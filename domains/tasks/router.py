"""
API Router per il dominio Tasks (API Layer / Presentation Layer).
...
def read_tasks(
    ...
    Args:
        ...
        conn: Connessione al database (injected by dependency)
    ...
    tasks = task_service.list_tasks(conn, username)
    return tasks
...
def create_task(
    ...
    created_task = task_service.create_task(conn, username, task)
    return created_task
...
def update_task(
    ...
    """
    # Delega tutta la logica al service
    updated_task = task_service.update_task(conn, username, task_id, task_update)
    return updated_task
...
def delete_task(
    ...
    """
    # Delega tutta la logica al service
    task_service.delete_task(conn, username, task_id)
